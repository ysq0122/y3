...
// JavaScript to handle favorite button toggle
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Change style based on selected color
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    let totalRating = reviewsCount * 4.9; // Initial total rating based on initial average rating
    let qualityTotalRating = reviewsCount * 4.9; // Initial quality total rating
    let conformityTotalRating = reviewsCount * 4.9; // Initial conformity total rating
    let speedTotalRating = reviewsCount * 4.9; // Initial speed total rating
